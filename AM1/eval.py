...
#     # Instead of making a dataset here, we want to insert the cluster dataset 
...
def _eval_dataset(model, dataset, width, softmax_temp, opts, device):
    ...
    # dont think i would need to use the dataloader because I only have one instance
    ...
    # Iteration 0: this works

    # Define the output file path
    # output_file = '/content/drive/MyDrive/Diss_Code/results.csv'

    # # Save the results to a CSV file
    # with open(output_file, 'w', newline='') as file:
    #     writer = csv.writer(file)
    #     writer.writerow(['Cost', 'Sequence', 'Duration'])  # Write header
    #     writer.writerows(results)  # Write data rows

    # Iteration 1: Not sure if this works, but wont tell me the cluster number
    ...
    #     if not file_exists:
    #         writer.writerow(['Cost', 'Sequence', 'Duration', ])

    #     writer.writerows(results)  # Append data rows

    # Iteration 2: This works, gives the cluster number
    ...
    results_with_cluster = [(cost, sequence, duration, new_cluster_number) for cost, sequence, duration in results]
